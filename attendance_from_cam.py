...
def capture_images_from_camera(camera_index=0, interval_seconds=2, num_images=10):
    image_list = []
    ...
    for _ in range(num_images):
        ...
        time.sleep(interval_seconds)  # Ensure 'time' here refers to the built-in time module
